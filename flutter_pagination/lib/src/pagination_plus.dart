...
class PaginationPlus extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // -----------------------------
    // Dynamic button calculation
    // -----------------------------
    final int maxButtonCount = isMobile
        ? 3
        : isTablet
            ? 5
            : 7; // Desktop default
    ...
    final int buttonCount =
        totalPages > maxButtonCount ? maxButtonCount : totalPages;

    final int sideButtonCount = buttonCount ~/ 2;

    int start = currentPageIndex - sideButtonCount;
    if (start < 0) start = 0;
